        ...
        <div class="container-fluid">
            <div class="row align-items-center header">
                ...
                <div class="col-auto d-flex">
                    <button class="btn btn-primary registro"> Registro </button> 
                    <button class="btn btn-primary acceso ml-2"> Acceso </button> 
                </div>
            </div>
            <div class="row image-row">
                <div class="col-lg-4 conferencias image-container">
                ...
                <div class="col-lg-4 seminarios image-container">
                    <div class="content-wrapper">
                ...
                <div class="col-lg-4 mesa-redonda image-container">
                    <div class="content-wrapper">
